				...
				<div class="row">
					<div class="col-2">
						...
						<ul class="nav flex-column">
							...
							<!-- 호버 시 커서 모양 바꿔야 함 -->
							<li class="nav-item mb-2">
							<object data="/bobn/web/resources/image/youtube.svg" type="image/svg+xml"><a href="#"></a></object>> &nbsp; 
							<object data="/bobn/web/resources/image/instagram.svg" type="image/svg+xml"><a href="#"></a></object>> &nbsp; 
							<object data="/bobn/web/resources/image/facebook.svg" type="image/svg+xml"><a href="#"></a></object>> &nbsp; 
							</li>
							<li class="nav-item mb-2"
