            ...
            <section>
                ...
                <article id="c_new_article1">
                    <div class="c_new_concept_btn_wrap">
                        <button type="button" class="c_new_country_btn" onclick="location.href='어디로이동할지적어야함';" id="c_new_kr">한식</button>
                        <button type="button" class="c_new_country_btn" onclick="location.href='어디로이동할지적어야함';">양식</button>
                        <button type="button" class="c_new_country_btn" onclick="location.href='어디로이동할지적어야함';">중식</button>
                        <button type="button" class="c_new_country_btn" onclick="location.href='어디로이동할지적어야함';">일식</button>
                        <button type="button" class="c_new_country_btn" onclick="location.href='어디로이동할지적어야함';">동남아</button>
                ...
                <article id="c_new_article2">
                    <table>
                        ...
                        <tr>
                            <td class="c_new_article2_text">소고기 미역국 / &#8361;5,000</td>
                            <td class="c_new_article2_text">순두부찌개 / &#8361;5,000</td>
                        ...
                        <tr>
                            <td class="c_new_article2_text">스테이크 / &#8361;20,000</td>
                            <td class="c_new_article2_text">순두부찌개 / &#8361;5,000</td>
                            <td class="c_new_article2_text">장어구이 / &#8361;15,000</td>
                        </tr>
                        <tr>
