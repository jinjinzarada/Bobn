...
<form action="<%=request.getContextPath()%>/blist" method="get"></form>
	...
	<div class="c_shopping-cart">
		...
		<div class="c_cart_item">
			...
			<div class="c_cart_description">
				<span>소고기 미역국</span> <span>담백한 맛</span>
			</div>
		...
		<div class="c_cart_item">
			...
			<div class="c_cart_image">
				<object data="/image/tofustew.png" alt="" width="70"></object>
			</div>

			<div class="c_cart_description">
				<span>순두부찌개</span> <span>얼큰한 맛</span>
			</div>
		...
		<div class="c_cart_item">
			...
			<div class="c_cart_image">
				<object data="/image/grilledeel.png" alt="" width="70"></object>
			</div>

			<div class="c_cart_description">
				<span>장어구이</span> <span>고소한 맛</span>
			</div>
