...
<div>
	...
	<div class="c_prodtail_image">
		<object
			data="<%=request.getContextPath()%>/resources/image/product/eggta.png"
			alt="" width="350"></object>
	</div>
	<!-- 상품tmi-->
	<div class="c_prodtail_right">
		<h3>간편하게 즐기는</h3>
		<h2 class="c_prodtail_proname">에그타르트</h2>
		<br>
		<span class="c_prodtail_special">특가상품 | 30% </span>
		<span><STRIKE>3,500 </STRIKE></span><br>
		<div class="c_prodtail_price_title">
			<span class="c_prodtail_price">2,800</span> <span>원</span>
		</div>
		<div class="c_prodtail_tmi">
			...
			<br> <span class="c_prodtail_cal_title">칼로리&nbsp; </span> <span
				class="c_prodtail_cal_title2">180kcal </span>
		</div>
