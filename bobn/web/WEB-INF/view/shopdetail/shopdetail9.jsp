...
<section>
	...
	<div class="c_prodtail_image">
		<object
			data="<%=request.getContextPath()%>/resources/image/product/steak.png"
			alt="" width="400"></object>
	</div>
	<!-- 상품tmi-->
	<div class="c_prodtail_right">
		<h3>간편하게 즐기는</h3>
		<h2 class="c_prodtail_proname">스테이크</h2>
		<br>
		<span class="c_prodtail_special">특가상품 | 50% </span>
		<span><STRIKE>20,000 </STRIKE></span><br>
