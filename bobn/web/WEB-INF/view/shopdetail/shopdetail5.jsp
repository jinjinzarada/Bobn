...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/shopdetail/shopdetail5.css">
	...
	<div class="c_prodtail_right">
		...
		<div class="c_prodtail_tmi">
			...
			<br> <span class="c_prodtail_cal_title">칼로리&nbsp; </span> <span
				class="c_prodtail_cal_title2">327kcal </span>
		</div>
