...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/shopdetail/shopdetail4.css">
...
<div>
	...
	<div class="c_prodtail_image">
		<object
			data="<%=request.getContextPath()%>/resources/image/product/forkkimchi.png"
			alt="" width="380"></object>
	</div>
	<!-- 상품tmi-->
	<div class="c_prodtail_right">
		<h3>간편하게 즐기는</h3>
		<h2 class="c_prodtail_proname">돼지김치찌개</h2>
		<br>
		<!--<span class="c_prodtail_special">특가상품 | 30% </span>
		<span><STRIKE>15,000 </STRIKE></span><br>-->
		<div class="c_prodtail_price_title">
			<span class="c_prodtail_price">10,000</span> <span>원</span>
		</div>
		<div class="c_prodtail_tmi">
			...
			<br> <span class="c_prodtail_cal_title">칼로리&nbsp; </span> <span
				class="c_prodtail_cal_title2">465kcal </span>
		</div>
