...
<div>
	...
	<div class="c_prodtail_image">
		<object
			data="<%=request.getContextPath()%>/resources/image/product/wollamssam.png"
			alt="" width="350"></object>
	</div>
	<!-- 상품tmi-->
	<div class="c_prodtail_right">
		<h3>간편하게 즐기는</h3>
		<h2 class="c_prodtail_proname">월남쌈</h2>
		<br>
		<span class="c_prodtail_special">특가상품 | 50% </span>
		<span><STRIKE>10,000 </STRIKE></span><br>
		...
		<div class="c_prodtail_tmi">
			...
			<br> <span class="c_prodtail_cal_title">칼로리&nbsp; </span> <span
				class="c_prodtail_cal_title2">80kcal </span>
		</div>
