...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/shopdetail/shopdetail8.css">
...
<div>
	...
	<div class="c_prodtail_image">
		<object
			data="<%=request.getContextPath()%>/resources/image/product/potatosuzebee.png"
			alt="" width="400"></object>
	</div>
	<!-- 상품tmi-->
	<div class="c_prodtail_right">
		<h3>간편하게 즐기는</h3>
		<h2 class="c_prodtail_proname">감자수제비</h2>
		<br>
